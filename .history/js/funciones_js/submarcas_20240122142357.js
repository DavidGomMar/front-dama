...
async function guardarSubmarca() {
    // Obtener el token desde sessionStoreNg
    const token = sessionStorage.getItem('jwt');
    ...
    try {
        // Obtener la imagen en base64 esperando la resolución de la promesa
        const imagenBase64 = await obtenerImagenBase64();
        ...
        const response = await fetch('http://localhost:8090/fama-market/api/subbrands/save', {
            method: 'POST',
            headers: headers,
