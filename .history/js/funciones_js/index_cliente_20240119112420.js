document.addEventListener("DOMContentLoaded", function () {
    ...
    // Mostrar u ocultar el menú de usuario según la presencia de un usuario logeado
    if (infousuario) {
        const usuarioLogeado = sessionStorage.getItem("usuario");
        infousuario.style.display = usuarioLogeado ? "block" : "none";
    }

    // Mostrar u ocultar el menú de usuario según la presencia de un usuario logeado
    if (menuUsuario) {
        const usuarioLogeado = sessionStorage.getItem("usuario");
        menuUsuario.style.display = usuarioLogeado ? "block" : "none";
    }
});
