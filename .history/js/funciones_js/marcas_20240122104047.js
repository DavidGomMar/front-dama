...
// Antes de la llamada a mostrarModalEliminar, agrega un log para verificar el ID de la marca
console.log("ID de la Marca a Eliminar (antes de llamar a la función):", brandIdAEliminar);

// Llama a la función para mostrar el modal
mostrarModalEliminar(brandIdAEliminar);
...
function eliminarMarca() {
    ...
    .then(response => {
        ...
        if (response.ok) {
            ...
            // Puedes realizar acciones adicionales después de eliminar la marca si es necesario
        } else {
            // Manejar el caso en el que la respuesta no sea exitosa
            console.error('Error al eliminar marca:', response.statusText);
            // Puedes lanzar un error o mostrar un mensaje al usuario según tu lógica de manejo de errores
            throw new Error('Error al eliminar marca');
        }
    })
    .catch(error => {
        // Manejar errores en la solicitud o en el proceso de eliminación
        console.error('Error al eliminar marca:', error);
        // Puedes mostrar un mensaje al usuario o realizar otras acciones según tu lógica de manejo de errores
    });
}
