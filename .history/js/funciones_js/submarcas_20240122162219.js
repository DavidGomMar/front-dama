...
// Evento de clic en el botón "Guardar" en el modal
document.getElementById('btnGuardar').addEventListener('click', function () {
    guardarSubmarca();
});

// Agregar un evento al botón Guardar en el modal
const btnGuardar = document.getElementById('btnGuardar');
btnGuardar.addEventListener('click', agregarSubmarca);


// Función para agregar submarca
function agregarSubmarca() {
    // Obtener el token desde sessionStoreNg
    const token = sessionStorage.getItem('jwt');
    ...
    .then(data => {
        ...
        // Puedes agregar más acciones aquí, como actualizar la lista de submarcas, etc.
    })
    .catch(error => {
