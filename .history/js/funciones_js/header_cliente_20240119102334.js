...
eliminarDatosButton.addEventListener("click", function () {
    // Eliminar los datos del sessionStorage
    sessionStorage.clear(); // Esto eliminará todos los datos almacenados en sessionStorage

    // Puedes también eliminar datos específicos utilizando sessionStorage.removeItem("nombreClave");

    // Puedes mostrar un mensaje o realizar otras acciones después de eliminar los datos
