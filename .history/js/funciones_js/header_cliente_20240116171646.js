        ...
        .then((data) => {
            ...
            familiasMap.forEach((categoriasMap, familiaName) => {
                ...
                categoriasMap.forEach((subcategoriasArray, categoriaName) => {
                    ...
                    // Verificar que categoryId no sea null antes de construir el enlace
                    const linkHref = categoryId !== null ? `Views/productos.html?categoriaId=${categoryId}` : 'Views/productos.html';
                    
                    categoriaItem.innerHTML = `<a href="${linkHref}">${categoriaName}</a>`;
