...
function confirmarEliminarProducto(productoId) {
    ...
    var modalBody = $("#modalBodyContent");  // Usar jQuery para obtener el elemento
    modalBody.html("<p>¿Estás seguro de que deseas eliminar este producto?</p>");

    // Actualizar el manejador de clic del botón Confirmar
    var btnConfirmar = $("#btnConfirmarAccion");  // Usar jQuery para obtener el elemento
...
function co----------------nfirmarEliminacion() {
