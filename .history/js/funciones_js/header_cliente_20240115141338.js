    ...
    fetch("http://localhost:8090/fama-market/api/subcategories/all", {headers})
        ...
        .then((data) => {
            ...
            familiasMap.forEach((categoriasMap, familiaName) => {
                ...
                familiaItem.innerHTML = `<a href="#" data-id="${familiaId}"> ${familiaName}</a>`;
                ...
                categoriasMap.forEach((subcategoriasArray, categoriaName) => {
                    ...
                    categoriaItem.innerHTML = `<a href="Views/productos.html" data-id="${categoriaId}">${categoriaName}</a>`;
                    ...
                    if (subcategoriasArray.length > 0) {
                        ...
                        subcategoriasArray.forEach((subcategoriaName) => {
                            ...
                            subcategoriaItem.innerHTML = `<a href="Views/productos.html" data-id="${categoriaId}">${subcategoriaName}</a>`;
