document.addEventListener("DOMContentLoaded", function () {
    ...
    // Utilizar operador ternario para llamar a la función correspondiente
    (categoriaId
        ? obtenerListaProductosByCategoria(categoriaId) && mostrarProductosByCategoria(categoriaId)
        : obtenerListaProductos() && mostrarProductos());
