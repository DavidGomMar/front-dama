                ...
                categoriasMap.forEach((subcategoriasArray, categoriaName) => {
                    ...
                    if (subcategoriasArray.length > 0) {
                        ...
                        subcategoriasArray.forEach((subcategoriaName) => {
                            ...
                            subcategoriaItem.innerHTML = `<a href="Views/productos.html?categoriaId=${categoriaId}&subcategoriaId=${subcategoriaId}"">${subcategoriaName}</a>`;
...
function obtenerIdDeLaURL() {
    ...
    console.log("categoriaId:", categoriaId); // Agrega este log
    return categoriaId;
}
