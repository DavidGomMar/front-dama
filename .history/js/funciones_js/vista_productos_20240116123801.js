...
console.log("Categoria ID en productos:", categoriaId);
console.log("Subcategoria ID en productos:", subcategoriaId);

// Aquí puedes realizar cualquier otra lógica relacionada con los IDs en la página de productos
