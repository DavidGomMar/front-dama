document.addEventListener("DOMContentLoaded", function () {
    ...
    if (menuUsuario) {
        const hayDatosEnSessionStorage = Object.keys(sessionStorage).length > 0;
        // Intenta establecer la propiedad 'display' utilizando el estilo directamente
        menuUsuario.style.cssText = `display: ${hayDatosEnSessionStorage ? "block" : "none"} !important;`;
    }
