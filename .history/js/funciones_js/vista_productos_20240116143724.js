...
// Obtén el ID de la categoría desde la ventana principal
const categoriaId = window.opener.obtenerCategoriaIdDesdeURL();

// Ahora puedes usar el ID de la categoría en tu lógica en la nueva ventana
console.log('ID de la categoría en la nueva ventana:', categoriaId);
