...
// Agregar eventos de clic a las subcategorías después de construir el menú
const subcategoriaEnlaces = document.querySelectorAll("#familiasMenu ul ul li a");
subcategoriaEnlaces.forEach((enlace) => {
    enlace.addEventListener("click", function (event) {
        event.preventDefault();
        const subcategoriaId = enlace.getAttribute("data-subcategoria-id");
