...
function guardarImagenes(productId, codeInternalProduct) {
    console.log("Entró a la función guardarImagenes");

    // Verifica si hay imágenes antes de continuar
    if (arrayImages.length === 0) {
        console.warn("No hay imágenes para guardar.");
        return;
    }
    ...
    arrayImages.forEach((image, index) => {
        ...
        console.log(`Imagen ${index + 1} agregada al arrayImagesForSends`);
    });

    console.log("Array de imágenes completo:", arrayImagesForSends);
