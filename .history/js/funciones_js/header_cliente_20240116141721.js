...
function obtenerIdDeLaCategoria(categoriasMap, categoriaName) {
    ...
    categoriasMap.forEach((subcategoriasArray) => {
        subcategoriasArray.forEach((subcategoria) => {
            ...
            if (subcategoria.category && subcategoria.category.nameCategory === categoriaName) {
                categoriaInfo = {
                    categoryId: subcategoria.category.categoryId,
                    categoryName: subcategoria.category.nameCategory,
                };
            }
        });
    });
