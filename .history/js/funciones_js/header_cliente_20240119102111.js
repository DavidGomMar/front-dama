        ...
        .then((data) => {
            ...
            familiasMap.forEach((categoriasMap, familiaName) => {
                ...
                categoriasMap.forEach((subcategoriasArray, categoriaName) => {
                    ...
                    categoriaItem.innerHTML = `<a href="Views/productos.html?categoriaId=${categoryId}">${categoriaName}</a>`;
                    ...
                    if (subcategoriasArray.length > 0) {
                        ...
                        subcategoriasArray.forEach((subcategoria) => {
                            ...
                            subcategoriaItem.innerHTML = `<a href="Views/productos.html?categoriaId=${categoryId}&subcategoriaId=${subcategoryId}">${subcategoria.nameSubCategory}</a>`;
...
cerrarSesionButton.addEventListener("click", function () {
    // Eliminar los datos específicos del sessionStorage relacionados con la sesión
    sessionStorage.removeItem("usuariosession");  // Ajusta el nombre de la clave según tus necesidades

    // Puedes agregar más líneas para eliminar otras variables de sesión si las tienes

    // Puedes redirigir a la página de inicio de sesión u realizar otras acciones después de cerrar la sesión
