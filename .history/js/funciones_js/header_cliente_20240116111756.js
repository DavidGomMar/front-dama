        ...
        .then((data) => {
            ...
            familiasMap.forEach((categoriasMap, familiaName) => {
                ...
                categoriasMap.forEach((subcategoriasArray, categoriaName) => {
                    ...
                    categoriaItem.innerHTML = `<a href="Views/productos.html" data-categoria-id="${categoria.categoryId}">${categoriaName}</a>`;
                    ...
                    if (subcategoriasArray.length > 0) {
                        ...
                        subcategoriasArray.forEach((subcategoriaName) => {
                            ...
                            subcategoriaItem.innerHTML = `<a href="Views/productos.html" data-subcategoria-id="${subcategoria.subCategoryId}">${subcategoriaName}</a>`;
