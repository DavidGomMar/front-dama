document.addEventListener("DOMContentLoaded", function () {
    ...
    function mostrarProductos(productos) {
        ...
        productos.forEach((pedidoProducto, index) => {
            ...
            cartItem.setAttribute("data-product-order-id", pedidoProducto.productOrderId); // Agregar el atributo con el productOrderId
    ...
    function eliminarProductoDelCarrito(productOrderId) {
        ...
        // Realizar la solicitud a la API para eliminar el producto
        ...
        .then((data) => {
            ...
            const cartItem = document.querySelector(`[data-product-order-id="${productOrderId}"]`);
            if (cartItem) {
                cartItem.remove();
            }
        })
